...
const footerHome = () => (
    <div>
        <div className="blue-links-home">
            <div className="container">
                <div className="row d-none d-sm-block d-md-none d-block d-sm-none">
                    <div rel="access-data-btn" className="col-md-4 col-sm-6 col-xs-12 nopad-l pad-l-mob">
                        <div className="data-btn radius-10">
                            <a href="https://ega-archive.org/submission-form.php/content.php?node=4" className="glyph-bottom"><i className="fa fa-download"></i></a>
                            <br/>
                            <a href="https://ega-archive.org/submission-form.php/content.php?node=4">I want to access data</a>
                        </div>
                    </div>
                    <div rel="submit-data-btn" className="col-md-4 col-sm-6 col-xs-12 nopad-l pad-l-mob marg-t-mob">
                        <div className="data-btn data-btn-mob radius-10">
                            <a href="https://ega-archive.org/submission-form.php/submission-form.php" className="glyph-bottom"><i className="fa fa-cloud-upload"></i></a>
                            <br/>
                            <a href="https://ega-archive.org/submission-form.php/submission-form.php">I have data to submit</a>
                        </div>
                    </div>
                </div>
                <div className="row">
                    <div className="col-md-2 col-md-offset-0 col-sm-6 col-sm-offset-0 col-xs-5 col-xs-offset-1">
                        <div className="browse-menu">
                            ...
                            <ul className="left-footer-links">
                                ...
                                <li>
                                    <a href="https://ega-archive.org/beacon/" target="_blank" rel="noopener noreferrer">
                                        <i className="fa fa-share-square-o fa-fw"></i>
                                        <span className="hover-line-white">Beacon</span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div className="d-block d-sm-none d-md-block d-none d-sm-block col-md-4 col-sm-6 col-xs-12 nopad-l">
                        <div className="data-btn radius-10">
                            <a href="https://ega-archive.org/access/data-access" className="glyph-bottom"><i className="fa fa-download"></i></a>
                            <br/>
                    ...
                    <div className="d-block d-sm-none d-md-block d-none d-sm-block col-md-4 col-sm-6 col-xs-12 nopad-l">
                        <div className="data-btn data-btn-mob radius-10">
                            <a href="https://ega-archive.org/submission-form.php" className="glyph-bottom"><i className="fa fa-cloud-upload"></i></a>
                            <br/>
                            <a href="https://ega-archive.org/submission-form.php">I have data to submit</a>
                        </div>
                        <div className="clearfix"></div>
                    </div>
                    <div className="col-md-2 col-sm-6 col-xs-6 pull-right">
